...
public final class Helper {
    public static func returnNavBarTitle(tabSelection: Tabs) -> String {
        switch tabSelection {
    ...
    public static func getGenreMovies(genreID: [Int]) -> [String] {
    ...
    public static func getDetailGenres(genres: [GenreModel]) -> String {
